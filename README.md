...
Review dashboard KPIs and the detection trend.

Identify the detection type and severity.

Review the affected computer and user.

Check the MITRE ATT&CK technique.

Examine ParentImage and CommandLine.

Use the dashboard drilldown to open related Sysmon events in Search
& Reporting.

Correlate surrounding endpoint activity before deciding whether
